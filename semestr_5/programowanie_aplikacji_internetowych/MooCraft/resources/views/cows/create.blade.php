        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('cows.store') }}"
                ...
                <div class="space-y-4">
                    ...
                    <!-- Breed -->
                    <div>
                        <x-input-label :value="__('Breed')"/>
                        <div class="mt-1 grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-1">
                            ...
                            @for ($i = 0; $i < 5; $i++)
                                <div id="color{{ $i }}"
                                    ...
                                    <div>
                                        ...
                                        <x-input-error :messages="$errors->get('colors.' . $i . '.color')"
                                                       class="mt-2"/>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <x-input-error :messages="$errors->get('colors.' . $i . '.weight')"
                                                       class="mt-2"/>
                                    </div>
                                </div>
                            @endfor
                    ...
                    <div>
                        ...
                        <textarea id="description"
                                  ...
                                  placeholder='{{ __("Describe a ridiculous cow that studies computer science, hasn't slept for 48 hours, and is fighting bugs in code instead of flies...") }}'>{{ old('description') }}</textarea>
